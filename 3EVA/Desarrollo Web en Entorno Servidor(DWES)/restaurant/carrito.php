...
<body>
    ...
    if (isset($_SESSION["user"]) && isset($_SESSION["contenidoCarrito"])) {
        ...
        if (!empty($_SESSION['contenidoCarrito'])) {
            ...
            <td>
                <form method='post'>
                    ...
                    <input type='submit' name='eliminar_del_carrito' class='boton' value='Eliminar del carrito'>
                </form>
            </td>
            </tr>";
                $total += ($item[1] * $item[2]);
        ...
        <form method='post'>
            <input type='submit' name='tramitar_pedido' class='boton' value='Tramitar pedido'>
        </form>
        </td></tr>";
            print "</table><br>";
            print "<form action='carta.php'>
                    <input type='submit' class='boton' value='Volver a la carta'>
                </form>";
        }
